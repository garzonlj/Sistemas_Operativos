/**************************************************************
	...
	Descripción: Este programa multiplica matrices de tamaño NxN
	             usando el algoritmo clásico de multiplicación 
	             paralelizado con hilos POSIX (Pthreads). El 
	             programa mide el tiempo de ejecución para 
	             analizar el rendimiento de la multiplicación 
	             en distintos tamaños y número de hilos.
...
#define DATA_SIZE (1024*1024*64*3)  // Tamaño del bloque de memoria compartida para matrices

// Variables globales
pthread_mutex_t MM_mutex;            // Mutex para sincronización
static double MEM_CHUNK[DATA_SIZE];   // Bloque de memoria compartida
...
// Variables de tiempo para medición de ejecución
...
/**
 * Función para imprimir una matriz si el tamaño es menor a 12x12,
